...
public class EjercicioHController2 implements Initializable{
    ...
    private EjercicioHController ejHController;
    ...
    void guardar(ActionEvent event) {
    	try {
        	...
        	if (txtNombre.getText().toString().equals("") || resultado==false || txtApellido.getText().toString().equals("") || txtEdad.getText().toString().equals("")) {
				...
				if (ejHController.isModificar()) {
					ejHController.modificarPersona(txtNombre.getText().toString(), txtApellido.getText().toString(), Integer.parseInt(txtEdad.getText().toString()));
					...
					if (ejHController.crearPersona(txtNombre.getText().toString(), txtApellido.getText().toString(),Integer.parseInt(txtEdad.getText().toString()))) {
						//Ventana de informacion
			        	Alert alert = new Alert(Alert.AlertType.INFORMATION);
			            alert.setTitle("Info");
			            alert.setHeaderText(null);
    ...
    public void initialize(URL location, ResourceBundle resources) {
    	if (ejHController!=null) {
    		if (ejHController.isModificar()) {
				txtNombre.setText(ejHController.getTbPersona().getSelectionModel().getSelectedItem().getNombre());
				txtApellido.setText(ejHController.getTbPersona().getSelectionModel().getSelectedItem().getApellido());
				txtEdad.setText(ejHController.getTbPersona().getSelectionModel().getSelectedItem().getEdad()+"");
			}
		}
    }
    
    public void setControlerH(EjercicioHController ej) {
    	this.ejHController = ej;
    }
