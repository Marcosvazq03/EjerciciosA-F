...
public class EjercicioFController2 implements Initializable{
    ...
    private static EjercicioFController ejFController;
    ...
    void guardar(ActionEvent event) {
    	try {
        	...
        	if (txtNombre.getText().toString().equals("") || resultado==false || txtApellido.getText().toString().equals("") || txtEdad.getText().toString().equals("")) {
				...
				if (ejFController.isModificar()) {
					ejFController.modificarPersona(txtNombre.getText().toString(), txtApellido.getText().toString(), Integer.parseInt(txtEdad.getText().toString()));
					...
					if (ejFController.crearPersona(txtNombre.getText().toString(), txtApellido.getText().toString(),Integer.parseInt(txtEdad.getText().toString()))) {
						//Ventana de informacion
			        	Alert alert = new Alert(Alert.AlertType.INFORMATION);
			            alert.setTitle("Info");
			            alert.setHeaderText(null);
    ...
    public void initialize(URL location, ResourceBundle resources) {
    	if (ejFController!=null) {
    		if (ejFController.isModificar()) {
				txtNombre.setText(ejFController.getTbPersona().getSelectionModel().getSelectedItem().getNombre());
				txtApellido.setText(ejFController.getTbPersona().getSelectionModel().getSelectedItem().getApellido());
				txtEdad.setText(ejFController.getTbPersona().getSelectionModel().getSelectedItem().getEdad()+"");
			}
		}
    }
