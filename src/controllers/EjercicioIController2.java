...
public class EjercicioIController2 implements Initializable{
    ...
    private EjercicioIController ejIController;
    ...
    void guardar(ActionEvent event) {
    	try {
        	...
        	if (txtNombre.getText().toString().equals("") || resultado==false || txtApellido.getText().toString().equals("") || txtEdad.getText().toString().equals("")) {
				...
				if (ejIController.isModificar()) {
					ejIController.modificarPersona(txtNombre.getText().toString(), txtApellido.getText().toString(), Integer.parseInt(txtEdad.getText().toString()));
					...
					if (ejIController.crearPersona(txtNombre.getText().toString(), txtApellido.getText().toString(),Integer.parseInt(txtEdad.getText().toString()))) {
						//Ventana de informacion
			        	Alert alert = new Alert(Alert.AlertType.INFORMATION);
			            alert.setTitle("Info");
			            alert.setHeaderText(null);
    ...
    public void initialize(URL location, ResourceBundle resources) {
    	if (ejIController!=null) {
    		if (ejIController.isModificar()) {
				txtNombre.setText(ejIController.getTbPersona().getSelectionModel().getSelectedItem().getNombre());
				txtApellido.setText(ejIController.getTbPersona().getSelectionModel().getSelectedItem().getApellido());
				txtEdad.setText(ejIController.getTbPersona().getSelectionModel().getSelectedItem().getEdad()+"");
			}
		}
    }
    
    public void setControlerI(EjercicioIController ej) {
    	this.ejIController = ej;
    }
