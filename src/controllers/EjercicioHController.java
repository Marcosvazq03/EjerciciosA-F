...
public class EjercicioHController implements Initializable{
    ...
    void agregar(ActionEvent event) {
    	modificar=false;
    	try {
    		FXMLLoader loader=new FXMLLoader(getClass().getResource("/fxml/EjercicioHfxml2.fxml"));
	    	Stage stage = new Stage();
	    	EjercicioHController2 ejHC2 = new EjercicioHController2();
